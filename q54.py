...
df = df_2015.append(df_2016, ignore_index=True).append(df_2017, ignore_index=True)
...
search_xgboost_tune = load('./models/Q54_XGboost_hyperparameter.joblib')
...
experiment.log_model("Q52_XGBOOST", './models/Q54_XGboost_hyperparameter.joblib')